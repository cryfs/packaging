...
vagrant up --provider=virtualbox --parallel ubuntu-18.10-x64 ubuntu-18.04-x64 ubuntu-16.04-x64 ubuntu-14.04-x64 debian-9-x64 debian-8-x64
#vagrant up --provider=digital_ocean ubuntu-18.10-x32 ubuntu-18.04-x32 ubuntu-16.04-x32 ubuntu-14.04-x32 debian-9-x32 debian-8-x32
